    ...
    <DayPicker
      ...
      classNames={{
        ...
        nav_button: cn(
          ...
          "h-8 w-8 bg-transparent p-0 hover:bg-accent hover:text-accent-foreground border-border/50 hover:border-border transition-all duration-200"
        ),
        ...
        day: cn(
          ...
          "h-10 w-10 p-0 font-normal aria-selected:opacity-100 hover:bg-accent hover:text-accent-foreground transition-all duration-200 rounded-md"
        ),
